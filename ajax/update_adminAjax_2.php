...
$err_phone=$err_email=$err_name=$err_repass="";
    ...
    if ($emailValid && $pass && $re_pass && $pass==$re_pass && $err_phone=="" && $name)
     {
         $rs = adminModel::getInstance()->updateAdmin($name, $pass, $phone, $email, $username);
          if($rs)
...
<div class="wrapper">
	...
	<div class="widget">
		...
		<form class="form" id="form" action="#"  method="get" name="updateAdmin"
